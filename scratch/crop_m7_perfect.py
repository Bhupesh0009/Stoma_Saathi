...
def crop_m7_illustrations():
    ...
    # Define our three illustration regions on the right side (X > 220)
    regions = [
        # (Y_start, Y_end, X_start, X_end)
        (100, 295, 220, width, "module7_stoma_colors.png"),
        (295, 475, 220, width, "module7_stoma_size_shape.png"),
        (475, 645, 220, width, "module7_stoma_bleeding.png")
    ]
    ...
    for y_start, y_end, x_start, x_end, filename in regions:
        ...
        # A pixel is considered white if R, G, B > 250
